...
!(function (e, t) {
  ...
  function W(e) {
    ...
    return (
      ...
      c
        ? Object.assign(Object.assign({}, r), {}, (((d = {})[h] = a ? "0" : ""), (d[m] = u ? "0" : ""), (d.transform = 2 > (v.devicePixelRatio || 1) ? "translate(" + e + "px, " + l + "px)" : "translate3d(" + e + "px, " + l + "px, 0)"), d))
      ...
      fn: function (e) {
        ...
        (r = void 0 === r || r),
          ...
          null != t.modifiersData.popperOffsets &&
            (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), W(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: r, roundOffsets: n })))),
...
!(function (t, e) {
  ...
  class et extends R {
    ...
    _addTouchEventListeners() {
      ...
      V.find(".carousel-item img", this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (H.on(this._element, "pointerdown.bs.carousel", (t) => e(t)), H.on(this._element, "pointerup.bs.carousel", (t) => s(t)), this._element.classList.add("pointer-event"))
          : (H.on(this._element, "touchstart.bs.carousel", (t) => e(t)), H.on(this._element, "touchmove.bs.carousel", (t) => i(t)), H.on(this._element, "touchend.bs.carousel", (t) => s(t)));
    }
    _keydown(t) {
  ...
  return F(Qt), b(Qt), { Alert: q, Button: W, Carousel: et, Collapse: nt, Dropdown: pt, Modal: Tt, Offcanvas: Lt, Popover: qt, ScrollSpy: Kt, Tab: Vt, Toast: Qt, Tooltip: Bt };
});
...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.Link = t.markSwupElements = t.getCurrentUrl = t.transitionEnd = t.fetch = t.getDataFromHtml = t.createHistoryRecord = t.classify = void 0);
      var i = d(n(8)),
        r = d(n(9)),
        o = d(n(10)),
        a = d(n(11)),
                    ...
                    "" != t.getHash()
                      ? (this.triggerEvent("samePageWithHash", e),
                        null != document.querySelector(t.getHash())
                          ? history.replaceState({ url: t.getAddress() + t.getHash(), random: Math.random(), source: "swup" }, document.title, t.getAddress() + t.getHash())
            ...
            },
            {
              ...
              value: function (e) {
                if (!this.options.skipPopStateHandling(e)) {
                  ...
                  "" !== t.getHash() ? (this.scrollToElement = t.getHash()) : e.preventDefault(), this.triggerEvent("popState", e), this.loadPage({ url: t.getAddress() }, e);
                }
              },
            },
          ]),
      ...
      t.default = function (e, t) {
        ...
        this.triggerEvent("transitionStart", t),
          null != e.customTransition
            ? (this.updateTransition(window.location.pathname, e.url, e.customTransition), document.documentElement.classList.add("to-" + (0, r.classify)(e.customTransition)))
        ...
        r = (function () {
          function e(t) {
            !(function (e, t) {
              ...
              t instanceof Element || t instanceof SVGElement ? (this.link = t) : ((this.link = document.createElement("a")), (this.link.href = t));
          }
          return (
            i(e, [
              {
    ...
    function (e, t, n) {
      ...
      t.default = function (e, t) {
        ...
        window.location.pathname !== o.getPath() && (window.history.replaceState({ url: o.getPath(), random: Math.random(), source: "swup" }, document.title, o.getPath()), this.cache.cacheUrl(i({}, e, { url: o.getPath() }))),
